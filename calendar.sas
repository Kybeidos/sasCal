...
date = "6Dec2014"d; note = "Nikolaus";  output;
date = "7DEC2014"d; note = "2. Advent";  output;
date = "14DEC2014"d; note = "3. Advent";  output;
date = "21DEC2014"d; note = "4. Advent";  output;
date = "24DEC2014"d; note = "Heiligabend";  output;
date = "25DEC2014"d; note = "1. Weihnachtstag";  output;
date = "26DEC2014"d; note = "2. Weihnachtstag";  output;
date = "31DEC2014"d; note = "Silvester";  output;
date = "10May2015"d; note = "Muttertag";  output;
date = "18Nov2015"d; note = "Buß- und Bettag";  output;
date = "29Nov2015"d; note = "1. Advent";  output;
...
date = "1Jan2016"d; note = "Neujahr";  output;
date = "6Jan2016"d; note = "Hl. Drei Könige";  output;
run;
...
If Wochentag ="Mo" then dom_notes= "^{style [fontsize=26pt]" || put(dom,2.)||"} " || trim(Wochentag)||" " || "^{style [fontsize=8pt]" ||trim(note)|| trim(Feiertag) ||"}" ||"                "||"^{style [fontsize=15pt]" ||put(kw,2.)||"}";
...
Data Ferien;
    ...
    input Ferienzeit :$18. Winter :$12. Ostern :$12. Pfingsten :$12. Sommer :$12. 
            Herbst :$12. Weihnachten :$12.;
run;
...
y=12.3cm
;
ods pdf text="^{style [cellwidth=85.6cm cellheight=48.3cm backgroundimage='&backgroundbody']}";
run;
...
style(column)=[font=(Arial, 16pt) cellheight=1.48cm cellwidth=5.5cm]
...
split='*';
label BW= 'Baden-Wtb' Mecklenburg_Vorp_= 'Mecklenburg-Vorp' Rheinland_Pfalz='Rheinland-Pfalz' Sachsen_Anhalt='Sachsen-Anhalt' Schleswig_Holstein='Schleswig-Holstein' Th_ringen = 'Thüringen' ;
...
^{nbspace 23} erstellt. Programmcode ist frei verfügbar auf: www.kybeidos.de/SAS-Kalender^{nbspace 26}*/^{newline}/*^{nbspace 184}*/
^{newline}/***********************************************************************************************************************
**************/";
run;
